...
export const DataTableBulkActions = <TData,>({
  ...
  useEffect(() => {
    if (selectedCount > 0) {
      const message = `${selectedCount} ${entityName} dipilih. Toolbar action tersedia.`;
  ...
  return (
    <>
      ...
      <div
        ref={toolbarRef}
        role="toolbar"
        aria-label={`Aksi untuk ${selectedCount} ${entityName} terpilih`}
        aria-describedby="bulk-actions-description"
        tabIndex={-1}
        className={cn(
          "fixed bottom-6 left-1/2 z-50 h-14 -translate-x-1/2 rounded-xl",
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="hidden sm:inline">{entityName}</span> dipilih
          </div>
